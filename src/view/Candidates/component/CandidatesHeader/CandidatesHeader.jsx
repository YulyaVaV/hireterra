...
const CandidatesHeader = () => {
  return (
    ...
    <svg className="candidates-header__bg" viewBox="0 0 1920 1566" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="candidates-header__wrapp">
      <h1 className="candidates-header__title">Candidates</h1>
