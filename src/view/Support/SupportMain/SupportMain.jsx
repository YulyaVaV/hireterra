...
const SupportMain = () => {
  return (
    <div className="support-main">
      <svg className="support-main__bg" viewBox="0 0 1920 1566" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="support-main__background"></div>
      <div className="support-main__content">
        <h3 className="support-main__content-title">Support</h3>
        <h4 className="support-main__content-subtitle">If you have any questions or suggestios, please submit the form below.</h4>
        <SupportForm />
        <OrangeButton title="Send Feedback"/> 
      </div>
    </div>
  )
}
